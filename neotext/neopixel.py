...
changed into a dummy for easier debugging the neotext lib dummy with CPython by Sebastian Heiden
"""
...
class NeoPixel:
    ...
    """
    ORDER = (1, 0, 2, 3)
    def __init__(self, n, *, bpp=3, brightness=1.0, auto_write=True):
